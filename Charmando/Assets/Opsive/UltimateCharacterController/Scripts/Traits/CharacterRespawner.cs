        ...
        public override void Respawn(Vector3 position, Quaternion rotation, bool transformChange)
        {
            ...
            if (m_CheckForObstruction) {
                ...
                for (int i = 0; i < m_Colliders.Length; ++i) {
                    ...
                    if (m_CharacterLocomotion.OverlapColliders(m_Colliders[i], m_CharacterLocomotion.Position + m_CharacterLocomotion.Up * m_CharacterLocomotion.ColliderSpacing, m_CharacterLocomotion.Rotation) > 0) {
                        obstruction = true;
                        break;
                    }
                }
